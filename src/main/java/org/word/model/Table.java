...
public class Table {
    ...
    private List<Request> headerList;
    ...
    private ModelAttr requestModelAttr=new ModelAttr();
	...
	public List<Request> getHeaderList() {
		return headerList;
	}

	public void setHeaderList(List<Request> headerList) {
	...
	public ModelAttr getRequestModelAttr() {
		return requestModelAttr;
	}

	public void setRequestModelAttr(ModelAttr requestModelAttr) {
		this.requestModelAttr = requestModelAttr;
	}
